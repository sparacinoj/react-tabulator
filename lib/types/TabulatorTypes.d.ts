declare namespace Tabulator {
    ...
    type RowContextMenuSignature = Array<MenuObject<RowComponent> | MenuSeparator> | ((component: RowComponent, e: MouseEvent) => MenuObject<RowComponent> | false | any[]);
