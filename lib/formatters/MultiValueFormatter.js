...
var Utils18_1 = require("../Utils18");
var MultiValueFormatter18_1 = require("./MultiValueFormatter18");
...
function default_1(cell, formatterParams, onRendered) {
    var _a = (0, Utils18_1.reactVersion)(), _ = _a[0], versionMaj = _a[1];
    if (versionMaj >= 18) {
        return (0, MultiValueFormatter18_1["default"])(cell, formatterParams, onRendered);
    }
